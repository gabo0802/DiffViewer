...
export function SettingsIcon({ size = 18, ...props }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} aria-hidden="true" {...props}>
      <path
        fill="currentColor"
        d="m10.825 22l-.35-2.65q-.325-.125-.613-.3t-.562-.4l-2.475 1.025l-1.85-3.2l2.125-1.65q-.05-.325-.075-.638T7 13.55q0-.3.025-.612t.075-.638l-2.125-1.65l1.85-3.2L9.3 8.475q.275-.225.563-.4t.612-.3l.35-2.65h3.7l.35 2.65q.325.125.613.3t.562.4l2.475-1.025l1.85 3.2l-2.125 1.65q.05.325.075.638T17 13.55q0 .3-.025.613t-.075.637l2.125 1.65l-1.85 3.2L14.7 18.625q-.275.225-.562.4t-.613.3L13.175 22zM12 16.5q1.45 0 2.475-1.025T15.5 13t-1.025-2.475T12 9.5t-2.475 1.025T8.5 13t1.025 2.475T12 16.5"
      />
    </svg>
  );
}
